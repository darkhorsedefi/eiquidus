...
// explorer view
exports.ex_title = "Bitcoin Luminary Block Explorer",
exports.ex_description = "A listing of all verified Bitcoin Luminary transactions",
...
// transaction view
exports.tx_title = "Bitcoin Luminary Transaction Details",
exports.tx_description = "Viewing tx data from Bitcoin Luminary block # {2}",
...
// block view
exports.block_title = "Bitcoin Luminary Block Details",
exports.block_description = "Viewing block data from Bitcoin Luminary block # {2}",
...
// error view
exports.error_title = "Bitcoin Luminary Block Explorer Error",
...
// address view
exports.a_title = "Bitcoin Luminary Wallet Address Details",
exports.a_description = "Viewing balance and transaction data from Bitcoin Luminary address {2}",
...
// masternode view
exports.mn_title = "Bitcoin Luminary Masternodes",
exports.mn_description = "A listing of all masternodes known to be active on the Bitcoin Luminary network",
exports.mn_masternode_list = "Masternode List",

// movement view
exports.move_title = "Bitcoin Luminary Coin Movements",
exports.move_description = "A listing of larger movements where Bitcoin Luminary or more {2} coins were sent in a single transaction",

// richlist view
exports.rl_title = "Top Bitcoin Luminary Coin Holders",
exports.rl_description = "A listing of the richest Bitcoin Luminary wallet addresses and breakdown of the current coin distribution",
...
// network view
exports.net_title = "Bitcoin Luminary Network Peers",
exports.net_description = "A listing of Bitcoin Luminary network peers that have connected to the explorer node in the last 24 hours",
...
// api view
exports.api_title = "Bitcoin Luminary Public API",
exports.api_description = "A listing of public API endpoints for retrieving Bitcoin Luminary coin data from the network without the need for a local wallet",
...
// markets view
exports.mkt_title = "Bitcoin Luminary Market Details",
exports.mkt_description = "Viewing Bitcoin Luminary market data for the {2} exchange",
...
// claim address view
exports.claim_title = "Bitcoin Luminary Wallet Address Claim",
exports.claim_description = "Verify ownership of your Bitcoin Luminary wallet address and set a custom display name in the explorer",

// orphans view
exports.orphan_title = "Bitcoin Luminary Orphaned Blocks",
...
exports.heavy_title = "Bitcoin Luminary Reward/Voting Details",
exports.heavy_description = "Viewing Bitcoin Luminary voting data and coin reward change details",
