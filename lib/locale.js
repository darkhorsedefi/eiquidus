...
// explorer view
exports.ex_title = "Nullion Block Explorer",
exports.ex_description = "A listing of all verified Nullion transactions",
...
// transaction view
exports.tx_title = "Nullion Transaction Details",
exports.tx_description = "Viewing tx data from Nullion block # {2}",
...
// block view
exports.block_title = "Nullion Block Details",
exports.block_description = "Viewing block data from Nullion block # {2}",
...
// error view
exports.error_title = "Nullion Block Explorer Error",
...
// address view
exports.a_title = "Nullion Wallet Address Details",
exports.a_description = "Viewing balance and transaction data from Nullion address {2}",
...
// masternode view
exports.mn_title = "Nullion Masternodes",
exports.mn_description = "A listing of all masternodes known to be active on the Nullion network",
exports.mn_masternode_list = "Masternode List",

// movement view
exports.move_title = "Nullion Coin Movements",
exports.move_description = "A listing of larger movements where Nullion or more {2} coins were sent in a single transaction",

// richlist view
exports.rl_title = "Top Nullion Coin Holders",
exports.rl_description = "A listing of the richest Nullion wallet addresses and breakdown of the current coin distribution",
...
// network view
exports.net_title = "Nullion Network Peers",
exports.net_description = "A listing of Nullion network peers that have connected to the explorer node in the last 24 hours",
...
// api view
exports.api_title = "Nullion Public API",
exports.api_description = "A listing of public API endpoints for retrieving Nullion coin data from the network without the need for a local wallet",
...
// markets view
exports.mkt_title = "Nullion Market Details",
exports.mkt_description = "Viewing Nullion market data for the {2} exchange",
...
// claim address view
exports.claim_title = "Nullion Wallet Address Claim",
exports.claim_description = "Verify ownership of your Nullion wallet address and set a custom display name in the explorer",

// orphans view
exports.orphan_title = "Nullion Orphaned Blocks",
...
exports.heavy_title = "Nullion Reward/Voting Details",
exports.heavy_description = "Viewing Nullion voting data and coin reward change details",
