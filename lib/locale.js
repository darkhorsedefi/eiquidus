...
// explorer view
exports.ex_title = "Kattcoin Block Explorer",
exports.ex_description = "A listing of all verified Kattcoin transactions",
...
// transaction view
exports.tx_title = "Kattcoin Transaction Details",
exports.tx_description = "Viewing tx data from Kattcoin block # {2}",
...
// block view
exports.block_title = "Kattcoin Block Details",
exports.block_description = "Viewing block data from Kattcoin block # {2}",
...
// error view
exports.error_title = "Kattcoin Block Explorer Error",
...
// address view
exports.a_title = "Kattcoin Wallet Address Details",
exports.a_description = "Viewing balance and transaction data from Kattcoin address {2}",
...
// masternode view
exports.mn_title = "Kattcoin Masternodes",
exports.mn_description = "A listing of all masternodes known to be active on the Kattcoin network",
exports.mn_masternode_list = "Masternode List",

// movement view
exports.move_title = "Kattcoin Coin Movements",
exports.move_description = "A listing of larger movements where Kattcoin or more {2} coins were sent in a single transaction",

// richlist view
exports.rl_title = "Top Kattcoin Coin Holders",
exports.rl_description = "A listing of the richest Kattcoin wallet addresses and breakdown of the current coin distribution",
...
// network view
exports.net_title = "Kattcoin Network Peers",
exports.net_description = "A listing of Kattcoin network peers that have connected to the explorer node in the last 24 hours",
...
// api view
exports.api_title = "Kattcoin Public API",
exports.api_description = "A listing of public API endpoints for retrieving Kattcoin coin data from the network without the need for a local wallet",
...
// markets view
exports.mkt_title = "Kattcoin Market Details",
exports.mkt_description = "Viewing Kattcoin market data for the {2} exchange",
...
// claim address view
exports.claim_title = "Kattcoin Wallet Address Claim",
exports.claim_description = "Verify ownership of your Kattcoin wallet address and set a custom display name in the explorer",

// orphans view
exports.orphan_title = "Kattcoin Orphaned Blocks",
...
exports.heavy_title = "Kattcoin Reward/Voting Details",
exports.heavy_description = "Viewing Kattcoin voting data and coin reward change details",
