...
// explorer view
exports.ex_title = "CmusicAI Block Explorer",
exports.ex_description = "A listing of all verified CmusicAI transactions",
...
// transaction view
exports.tx_title = "CmusicAI Transaction Details",
exports.tx_description = "Viewing tx data from CmusicAI block # {2}",
...
// block view
exports.block_title = "CmusicAI Block Details",
exports.block_description = "Viewing block data from CmusicAI block # {2}",
...
// error view
exports.error_title = "CmusicAI Block Explorer Error",
...
// address view
exports.a_title = "CmusicAI Wallet Address Details",
exports.a_description = "Viewing balance and transaction data from CmusicAI address {2}",
...
// masternode view
exports.mn_title = "CmusicAI Masternodes",
exports.mn_description = "A listing of all masternodes known to be active on the CmusicAI network",
exports.mn_masternode_list = "Masternode List",

// movement view
exports.move_title = "CmusicAI Coin Movements",
exports.move_description = "A listing of larger movements where CmusicAI or more {2} coins were sent in a single transaction",

// richlist view
exports.rl_title = "Top CmusicAI Coin Holders",
exports.rl_description = "A listing of the richest CmusicAI wallet addresses and breakdown of the current coin distribution",
...
// network view
exports.net_title = "CmusicAI Network Peers",
exports.net_description = "A listing of CmusicAI network peers that have connected to the explorer node in the last 24 hours",
...
// api view
exports.api_title = "CmusicAI Public API",
exports.api_description = "A listing of public API endpoints for retrieving CmusicAI coin data from the network without the need for a local wallet",
...
// markets view
exports.mkt_title = "CmusicAI Market Details",
exports.mkt_description = "Viewing CmusicAI market data for the {2} exchange",
...
// claim address view
exports.claim_title = "CmusicAI Wallet Address Claim",
exports.claim_description = "Verify ownership of your CmusicAI wallet address and set a custom display name in the explorer",

// orphans view
exports.orphan_title = "CmusicAI Orphaned Blocks",
...
exports.heavy_title = "CmusicAI Reward/Voting Details",
exports.heavy_description = "Viewing CmusicAI voting data and coin reward change details",
