...
// explorer view
exports.ex_title = "Wagyucoin Block Explorer",
exports.ex_description = "A listing of all verified Wagyucoin transactions",
...
// transaction view
exports.tx_title = "Wagyucoin Transaction Details",
exports.tx_description = "Viewing tx data from Wagyucoin block # {2}",
...
// block view
exports.block_title = "Wagyucoin Block Details",
exports.block_description = "Viewing block data from Wagyucoin block # {2}",
...
// error view
exports.error_title = "Wagyucoin Block Explorer Error",
...
// address view
exports.a_title = "Wagyucoin Wallet Address Details",
exports.a_description = "Viewing balance and transaction data from Wagyucoin address {2}",
...
// masternode view
exports.mn_title = "Wagyucoin Masternodes",
exports.mn_description = "A listing of all masternodes known to be active on the Wagyucoin network",
exports.mn_masternode_list = "Masternode List",

// movement view
exports.move_title = "Wagyucoin Coin Movements",
exports.move_description = "A listing of larger movements where Wagyucoin or more {2} coins were sent in a single transaction",

// richlist view
exports.rl_title = "Top Wagyucoin Coin Holders",
exports.rl_description = "A listing of the richest Wagyucoin wallet addresses and breakdown of the current coin distribution",
...
// network view
exports.net_title = "Wagyucoin Network Peers",
exports.net_description = "A listing of Wagyucoin network peers that have connected to the explorer node in the last 24 hours",
...
// api view
exports.api_title = "Wagyucoin Public API",
exports.api_description = "A listing of public API endpoints for retrieving Wagyucoin coin data from the network without the need for a local wallet",
...
// markets view
exports.mkt_title = "Wagyucoin Market Details",
exports.mkt_description = "Viewing Wagyucoin market data for the {2} exchange",
...
// claim address view
exports.claim_title = "Wagyucoin Wallet Address Claim",
exports.claim_description = "Verify ownership of your Wagyucoin wallet address and set a custom display name in the explorer",

// orphans view
exports.orphan_title = "Wagyucoin Orphaned Blocks",
...
exports.heavy_title = "Wagyucoin Reward/Voting Details",
exports.heavy_description = "Viewing Wagyucoin voting data and coin reward change details",
