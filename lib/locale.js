...
// explorer view
exports.ex_title = "Antero Coin Block Explorer",
exports.ex_description = "A listing of all verified Antero Coin transactions",
...
// transaction view
exports.tx_title = "Antero Coin Transaction Details",
exports.tx_description = "Viewing tx data from Antero Coin block # {2}",
...
// block view
exports.block_title = "Antero Coin Block Details",
exports.block_description = "Viewing block data from Antero Coin block # {2}",
...
// error view
exports.error_title = "Antero Coin Block Explorer Error",
...
// address view
exports.a_title = "Antero Coin Wallet Address Details",
exports.a_description = "Viewing balance and transaction data from Antero Coin address {2}",
...
// masternode view
exports.mn_title = "Antero Coin Masternodes",
exports.mn_description = "A listing of all masternodes known to be active on the Antero Coin network",
exports.mn_masternode_list = "Masternode List",

// movement view
exports.move_title = "Antero Coin Coin Movements",
exports.move_description = "A listing of larger movements where Antero Coin or more {2} coins were sent in a single transaction",

// richlist view
exports.rl_title = "Top Antero Coin Coin Holders",
exports.rl_description = "A listing of the richest Antero Coin wallet addresses and breakdown of the current coin distribution",
...
// network view
exports.net_title = "Antero Coin Network Peers",
exports.net_description = "A listing of Antero Coin network peers that have connected to the explorer node in the last 24 hours",
...
// api view
exports.api_title = "Antero Coin Public API",
exports.api_description = "A listing of public API endpoints for retrieving Antero Coin coin data from the network without the need for a local wallet",
...
// markets view
exports.mkt_title = "Antero Coin Market Details",
exports.mkt_description = "Viewing Antero Coin market data for the {2} exchange",
...
// claim address view
exports.claim_title = "Antero Coin Wallet Address Claim",
exports.claim_description = "Verify ownership of your Antero Coin wallet address and set a custom display name in the explorer",

// orphans view
exports.orphan_title = "Antero Coin Orphaned Blocks",
...
exports.heavy_title = "Antero Coin Reward/Voting Details",
exports.heavy_description = "Viewing Antero Coin voting data and coin reward change details",
