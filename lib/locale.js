...
// explorer view
exports.ex_title = "Bitcoin Free Block Explorer",
exports.ex_description = "A listing of all verified Bitcoin Free transactions",
...
// transaction view
exports.tx_title = "Bitcoin Free Transaction Details",
exports.tx_description = "Viewing tx data from Bitcoin Free block # {2}",
...
// block view
exports.block_title = "Bitcoin Free Block Details",
exports.block_description = "Viewing block data from Bitcoin Free block # {2}",
...
// error view
exports.error_title = "Bitcoin Free Block Explorer Error",
...
// address view
exports.a_title = "Bitcoin Free Wallet Address Details",
exports.a_description = "Viewing balance and transaction data from Bitcoin Free address {2}",
...
// masternode view
exports.mn_title = "Bitcoin Free Masternodes",
exports.mn_description = "A listing of all masternodes known to be active on the Bitcoin Free network",
exports.mn_masternode_list = "Masternode List",

// movement view
exports.move_title = "Bitcoin Free Coin Movements",
exports.move_description = "A listing of larger movements where Bitcoin Free or more {2} coins were sent in a single transaction",

// richlist view
exports.rl_title = "Top Bitcoin Free Coin Holders",
exports.rl_description = "A listing of the richest Bitcoin Free wallet addresses and breakdown of the current coin distribution",
...
// network view
exports.net_title = "Bitcoin Free Network Peers",
exports.net_description = "A listing of Bitcoin Free network peers that have connected to the explorer node in the last 24 hours",
...
// api view
exports.api_title = "Bitcoin Free Public API",
exports.api_description = "A listing of public API endpoints for retrieving Bitcoin Free coin data from the network without the need for a local wallet",
...
// markets view
exports.mkt_title = "Bitcoin Free Market Details",
exports.mkt_description = "Viewing Bitcoin Free market data for the {2} exchange",
...
// claim address view
exports.claim_title = "Bitcoin Free Wallet Address Claim",
exports.claim_description = "Verify ownership of your Bitcoin Free wallet address and set a custom display name in the explorer",

// orphans view
exports.orphan_title = "Bitcoin Free Orphaned Blocks",
...
exports.heavy_title = "Bitcoin Free Reward/Voting Details",
exports.heavy_description = "Viewing Bitcoin Free voting data and coin reward change details",
