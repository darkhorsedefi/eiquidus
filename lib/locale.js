...
// explorer view
exports.ex_title = "RAIA Network Block Explorer",
exports.ex_description = "A listing of all verified RAIA Network transactions",
...
// transaction view
exports.tx_title = "RAIA Network Transaction Details",
exports.tx_description = "Viewing tx data from RAIA Network block # {2}",
...
// block view
exports.block_title = "RAIA Network Block Details",
exports.block_description = "Viewing block data from RAIA Network block # {2}",
...
// error view
exports.error_title = "RAIA Network Block Explorer Error",
...
// address view
exports.a_title = "RAIA Network Wallet Address Details",
exports.a_description = "Viewing balance and transaction data from RAIA Network address {2}",
...
// masternode view
exports.mn_title = "RAIA Network Masternodes",
exports.mn_description = "A listing of all masternodes known to be active on the RAIA Network network",
exports.mn_masternode_list = "Masternode List",

// movement view
exports.move_title = "RAIA Network Coin Movements",
exports.move_description = "A listing of larger movements where RAIA Network or more {2} coins were sent in a single transaction",

// richlist view
exports.rl_title = "Top RAIA Network Coin Holders",
exports.rl_description = "A listing of the richest RAIA Network wallet addresses and breakdown of the current coin distribution",
...
// network view
exports.net_title = "RAIA Network Network Peers",
exports.net_description = "A listing of RAIA Network network peers that have connected to the explorer node in the last 24 hours",
...
// api view
exports.api_title = "RAIA Network Public API",
exports.api_description = "A listing of public API endpoints for retrieving RAIA Network coin data from the network without the need for a local wallet",
...
// markets view
exports.mkt_title = "RAIA Network Market Details",
exports.mkt_description = "Viewing RAIA Network market data for the {2} exchange",
...
// claim address view
exports.claim_title = "RAIA Network Wallet Address Claim",
exports.claim_description = "Verify ownership of your RAIA Network wallet address and set a custom display name in the explorer",

// orphans view
exports.orphan_title = "RAIA Network Orphaned Blocks",
...
exports.heavy_title = "RAIA Network Reward/Voting Details",
exports.heavy_description = "Viewing RAIA Network voting data and coin reward change details",
