...
// explorer view
exports.ex_title = "XenixChain Block Explorer",
exports.ex_description = "A listing of all verified XenixChain transactions",
...
// transaction view
exports.tx_title = "XenixChain Transaction Details",
exports.tx_description = "Viewing tx data from XenixChain block # {2}",
...
// block view
exports.block_title = "XenixChain Block Details",
exports.block_description = "Viewing block data from XenixChain block # {2}",
...
// error view
exports.error_title = "XenixChain Block Explorer Error",
...
// address view
exports.a_title = "XenixChain Wallet Address Details",
exports.a_description = "Viewing balance and transaction data from XenixChain address {2}",
...
// masternode view
exports.mn_title = "XenixChain Masternodes",
exports.mn_description = "A listing of all masternodes known to be active on the XenixChain network",
exports.mn_masternode_list = "Masternode List",

// movement view
exports.move_title = "XenixChain Coin Movements",
exports.move_description = "A listing of larger movements where XenixChain or more {2} coins were sent in a single transaction",

// richlist view
exports.rl_title = "Top XenixChain Coin Holders",
exports.rl_description = "A listing of the richest XenixChain wallet addresses and breakdown of the current coin distribution",
...
// network view
exports.net_title = "XenixChain Network Peers",
exports.net_description = "A listing of XenixChain network peers that have connected to the explorer node in the last 24 hours",
...
// api view
exports.api_title = "XenixChain Public API",
exports.api_description = "A listing of public API endpoints for retrieving XenixChain coin data from the network without the need for a local wallet",
...
// markets view
exports.mkt_title = "XenixChain Market Details",
exports.mkt_description = "Viewing XenixChain market data for the {2} exchange",
...
// claim address view
exports.claim_title = "XenixChain Wallet Address Claim",
exports.claim_description = "Verify ownership of your XenixChain wallet address and set a custom display name in the explorer",

// orphans view
exports.orphan_title = "XenixChain Orphaned Blocks",
...
exports.heavy_title = "XenixChain Reward/Voting Details",
exports.heavy_description = "Viewing XenixChain voting data and coin reward change details",
